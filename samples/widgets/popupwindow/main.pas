...
uses
 ...
 sysutils,msesimplewidgets,mclasses;

type

 thintpopup = class(tpopupwidget)
  protected
   fplacementrect: rectty;
   fplacement: captionposty;
   frefpos: pointty;
  ...
  public
   constructor create(aowner: tcomponent; atransientfor: twindow;
...
begin
 thintpopup.create(nil,window,window.focusedwidget.widgetscreenrect);
end;
